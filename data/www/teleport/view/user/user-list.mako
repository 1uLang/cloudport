...
##                         <li><a href="javascript:;" data-action="ldap-sync"><i class="fas fa-link fa-fw"></i> 同步LDAP</a></li>
    ...
    <div class="box">
        ...
        <ul class="help-list">
            ...
            <li>批量导入用户需要上传.csv格式的文件，您可以 <a href="/static/download/cloudfort-example-user.csv"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div style="text-align:center;margin:10px 0 20px 0;">
                        <p>请点击图标，选择要上传的文件！</p>
                        <p><a href="/static/download/cloudfort-example-user.csv"><i class="fa fa-download fa-fw"></i>下载用户信息文件模板</a>
                        </p>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-6">
                                <div class="control-desc-sm">LDAP的账号使用 <span class="important">用户名@域</span> 来登录cloudfort。
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                                <div class="control-desc-sm">将LDAP的属性映射到 cloudfort的用户属性，例如 <span class="important">LDAP中的用户属性 sAMAccountName 映射为cloudfort的登录账号</span>。如果不清楚此LDAP服务的用户属性，可使用下方的“列举属性”按钮进行查询。</div>
                            </div>
                        </div>
