    ...
    <div class="info-box">
        ...
        <div class="info-message-box">
            ...
            <div id="content" class="content">
                ...
                <p>请注意检查您的手机时间与cloudfort服务器时间是否同步，如果两者<span class="important">时间偏差超过两分钟则无法绑定</span>，请及时通知系统管理员处理！</p>
                <div class="time-box"><i class="fa fa-clock-o"></i> CLOUDFORT服务器时间：<span class="tp-time mono" id="teleport-time">-</span></div>
                    ...
                    <div id="area-auth">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input data-field="input-username" type="text" class="form-control mono" placeholder="cloudfort系统用户名" data-toggle="popover" data-trigger="manual" data-placement="top">
                            </div>
