...
<div class="page-content-inner">
    ...
    <div class="box">
        ...
        <ul class="help-list">
            ...
            <li><em>用户创建/编辑</em> 允许创建或编辑登录cloudfort系统的用户账号。</li>
            <li><em>删除用户</em> 允许删除登录cloudfort系统的用户。</li>
            <li><em>用户禁用/解禁</em> 允许设置禁止用户访问cloudfort系统，或者解禁。当用户因连续认证失败而被临时锁定时，也可由此权限进行解锁。</li>
            ...
            <li><em>系统配置与维护</em> 允许对cloudfort系统进行配置和维护操作。</li>
##             <li><em>历史会话管理</em> 允许查看用户在cloudfort系统上的操作记录。</li>
            <li><em>查看系统日志</em> 允许查看用户在cloudfort系统上的操作记录。</li>
        </ul>
        <p>特别注意：cloudfort系统使用<strong>最小权限判定规则</strong>，也即，在检查权限时，会按用户所具有的最小权限进行判断。例如：如用户无远程主机运维权限，那么即使其所在用户组被授权访问某远程主机，此用户也无法连接到该远程主机。</p>
    </div>
</div>
