...
<div class="content-box">
    <p class="welcome-message"><i class="fa fa-heart"></i> <span>欢迎安装使用 CLOUDFORT v${app_ver.TP_SERVER_VER} 社区版！</span></p>

    <hr/>
    <h2><i class="fa fa-chevron-right"></i> 确定数据库类型</h2>
    <div>
        <p>CLOUDFORT支持 SQLite 和 MySQL 数据库，您目前使用的配置如下：</p>
    ...
    <p>准备就绪了？配置操作将创建CLOUDFORT服务所需的数据库，并设置系统管理员账号！</p>
    ...
    <div id="step2" style="display:none;">
        ...
        <p>是的，就这么简单，安装配置已经完成了！刷新页面即可登录 CLOUDFORT 啦~~</p>
    </div>
