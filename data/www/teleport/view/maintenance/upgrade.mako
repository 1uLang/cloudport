...
<div class="content-box">
    <p class="welcome-message"><i class="fa fa-heart"></i> <span>欢迎升级到 CLOUDFORT v${app_ver.TP_SERVER_VER} 社区版！现在还剩下一点点操作需要执行！</span></p>
    ...
    <div id="step2" style="display:none;">
        ...
        <p>是的，没有第二步啦，升级已经完成！刷新页面即可登录 CLOUDFORT	 啦~~</p>
    </div>
