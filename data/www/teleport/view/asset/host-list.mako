...
<div class="page-content-inner">
    ...
    <div class="box">
        ...
        <ul class="help-list">
            ...
            <li>批量导入主机和账号需要上传.csv格式的文件，您可以 <a href="/static/download/cloudfort-example-asset.csv"><i class="fa fa-download fa-fw"></i>下载资产信息文件模板</a> 进行编辑。</li>
        </ul>
    </div>
</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div style="text-align:center;margin:10px 0 20px 0;">
                        <p>请点击图标，选择要上传的文件！</p>
                        <p><a href="/static/download/cloudfort-example-asset.csv"><i class="fa fa-download fa-fw"></i>下载资产信息文件模板</a></p>
                    </div>
